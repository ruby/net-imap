...
module Net
  class IMAP
    ...
    # - #intersect!: Removes numbers that are not in the given set; returns
    #   +self+.
    ...
    class SequenceSet
      ...
      # Removes any elements that are missing from +other+ from this set,
      # keeping only the #intersection, and returns +self+.
      #
      # +other+ may be any object that would be accepted by ::new.
      #
