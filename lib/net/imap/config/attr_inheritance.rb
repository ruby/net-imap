  ...
  class IMAP
    class Config
      ...
      module AttrInheritance
        ...
        # version number when all attributes inherit from either a versioned
        # default or Config.default (see Config@Versioned+defaults), +nil+ if
        # any attributes inherit from Config.global overrides (and not from
